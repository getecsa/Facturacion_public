...
<div id="divNotificacion" />
  <div class="contenedor">
              <div class="header">
                  ...
                  <h1 class="h1_header">Nueva Refactura con cambio</h1> <h2 class="subtitulo"><?=$row['tx_tipo_cliente']?></h2>
              </div>
  <div class="content">
                  <form class="formulario_n" action="homepage.php?id=refactura_con_cambio_pro" method="post" name="form1" id="form1">
                      <div class="column">
                        ...
                        <label for="codigo_cliente_afectar"><p>CC.(Fac. Afectar):</p></label><input type="text" name="codigo_cliente_afectar" id="codigo_cliente_afectar" <?php if($return==1){ echo 'value="'.$codigo_cliente_afectar.'"';} else{ ?>  value="<?php echo $_POST['codigo_cliente_afectar'];} ?>" readonly="readonly" />
                      ...
                      <div class="column">      
                       ...
                       --> <label for="entrada"><p>Entrada:</p></label><input type="text" name="entrada" id="entrada" <?php if($return==1){ echo 'value="'.$entrada.'"';} ?>/>
                        ...
                        <label for="mt_fac_orig"><p>Total (Fac Origen):</p></label><input type="text" name="mt_fac_orig" id="mt_fac_orig" <?php if($return==1){ echo 'value="'.$mt_fac_orig.'"';} ?>/>
                        <label for="monto_afectar_nc"><p>Afectar con NC:</p></label><input type="text" name="monto_afectar_nc" id="monto_afectar_nc" <?php if($return==1){ echo 'value="'.$monto_afectar_nc.'"';} ?> />
