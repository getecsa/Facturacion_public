...
<tr >
                        <td colspan="9" align="right" bgcolor="00517A"><font color="#fff">Filtro de solicitud:
<form action="operacion_ATC.php" method="post" id="id_estados_sol">
...
?>
                    <tr  bgcolor="<?php echo $color; ?>">
                        ...
                        <td ><?php echo $row["fecha_cierre"]; ?></td>                 
               			<td><a href="homepage.php?id=operacion_ATC" class="tomar_solicitud" id="<?php echo $row['id']; ?>"><span class="icon-checkmark espacio"></span></a></td>
