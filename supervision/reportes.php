<?php
/**
* Controlador de la sección de Reportes.
*
* PHP version 5
*
	...
	if(true){
		...
		//if($user->checkAccessUser($_SESSION['usuario']['id'])){
			...
			switch($mod){
				...
				case 'reportes':
					$menu->verMenu($mod,'Supervisor de ' . 'Direccionamiento' . ' - Reportes - Gesofa - Telefónica');
					switch($acc){
						case 'form':
							include_once 'reportes/consultaReporteForm.php';
							break;
						case 'con':
						...
						default:
							...
							$tpl->prepare();
							$tpl->assign('mensaje','Error al Procesar Acción');
							$tpl->printToScreen();
							break;
					}
					break;
